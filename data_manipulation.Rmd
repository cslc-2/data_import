...
THIS IS AN INCORRECT WAY TO WRITE THIS!!!! DON'T DO THIS!
```{r}
...
`select` vs `pull`
Select will select a data frame. Pull will pull the column out and treat it like a vector.
You should almost never be taking stuff out of the data frame if you have a data frame.
...
pipes and viewing
But remember to delete view() before you publish your R markdown. It should just be a temporary step.
